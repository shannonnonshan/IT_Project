...
(29, 3),   -- Made - BIGBANG
(30, 43),  -- 13 Reasons Why: Season 2 - Many singers
...
CREATE TABLE `songs` (
  ...
  `CatID` int(11) NOT NULL, -- Sửa thành kiểu số nguyên
  `ReleaseDate` date NOT NULL,
  `AlbumID` int(11) DEFAULT NULL, -- Cho phép giá trị NULL
